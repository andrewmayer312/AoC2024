def processCompletedArray(in_array):
    ...
    if len(first_arg) > 3 or len(second_arg) > 3:
        return 0
...
def main():
    ...
    with open("input.txt", "r") as file:
        ...
        while True:
            ...
            if (in_char == 'm' or in_char == 'd') and not operation_array:
                ...
                # first digit of first arguement
                    ...
                    operation_array.append(in_char)
                    continue
                elif in_char == ',' and operation_array[
                    -1].isdigit() and first_operand_added == True and second_operand_added == False:
                    operation_array.append(in_char)
                    first_operand_added = False
                    continue
                elif in_char.isdigit() and operation_array[-1] == ',' and second_operand_added == False:
                    operation_array.append(in_char)
                    ...
                    operation_array.append(in_char)
                    continue
                elif in_char == ')' and operation_array[-1].isdigit() and second_operand_added == True and perform_next_intruction == True:
                    operation_array.append(in_char)
                    ...
                    second_operand_added = False
                    continue
                elif in_char == 'o' and operation_array[-1] == 'd':
                    operation_array.append(in_char)
                    continue
                elif in_char == '(' and operation_array[-1] == 'o':
                    operation_array.append(in_char)
                    continue
                elif in_char == 'n' and operation_array[-1] == 'o':
                    operation_array.append(in_char)
                    continue
                elif in_char == "'" and operation_array[-1] == 'n':
                    operation_array.append(in_char)
                    continue
                elif in_char == 't' and operation_array[-1] == "'":
                    operation_array.append(in_char)
                    continue
                elif in_char == '(' and operation_array[-1] == "t":
                    operation_array.append(in_char)
                    continue
                elif in_char == ')' and operation_array[-1] == "(" and operation_array[-2] == 't':
                    perform_next_intruction = False
                    operation_array.append(in_char)
                    print(operation_array)
                    print('Operation Disabled')
                    operation_array = []
                    continue
                elif in_char == ')' and operation_array[-1] == "(" and operation_array[-2] == 'o':
                    perform_next_intruction = True
                    operation_array.append(in_char)
                    print(operation_array)
